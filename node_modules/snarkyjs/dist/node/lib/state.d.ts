 ...
 *
 */
declare function state<A>(stateType: ProvablePure<A>): (target: SmartContract & {
    constructor: any;
 ...
 * ```
 */
declare function declareState<T extends typeof SmartContract>(SmartContract: T, states: Record<string, ProvablePure<unknown>>): void;
