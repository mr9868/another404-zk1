...
export { Field, Bool, Circuit, Poseidon, Group, Scalar, Ledger, shutdown, isReady, Pickles, };
let isReadyBoolean = false;
let isReady = snarky_ready.then(() => (isReadyBoolean = true));
let isItReady = () => isReadyBoolean;
let { Field, Bool, Circuit, Poseidon, Group, Scalar, Ledger, Pickles } = proxyClasses(getSnarky, isItReady, snarkySpec);
